        ...
        [
          ...
          column(
            ...
            [
              ...
              metric("329", "passing tests after final polish", C.blue),
...
function addRealVsPrototype() {
  ...
  slideBase(slide, [
    ...
    row(
      ...
      [pill("329 tests passed", C.tealDeep), pill("Live Fly deployment", C.blue), pill("OpenRouter model configurable", C.violet)],
    ),
    footer(),
  ]);
  addNotes(slide, `
